% SYSTEM.HARDWARE
%   Class containing hardware constants (Aixplorer).
%
%   Constants:
...
properties ( Constant = true )
    ...
    NbTxChan = int32(128); % number of TX channels
    NbRxChan = int32(64); % number of RX channels

    % TX constants
    MaxTxFreq = single(20); % MHz
