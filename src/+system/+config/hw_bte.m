% SYSTEM.HARDWARE
%   Class containing hardware constants (Brain Therapy).
%
%   Constants:
...
properties ( Constant = true )
    ...
    NbTxChan = int32(512); % number of TX channels
    NbRxChan = int32(256); % number of RX channels

    % TX constants
    MaxTxFreq = single(2); % MHz
