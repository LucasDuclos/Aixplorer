...
NumberLinesPerBox = 2;
warning( ['NumberLinesPerBox hardcoded to : ' num2str(NumberLinesPerBox)] )
...
if RemainingTime >= 0
    ...
    error( ['PRF too high, max possible is ' num2str( 1e6 / (NumberLinesPerBox * (EventRxDur + system.hardware.MinNoop)) ) ] )
end
...
warning( ['NumberBoxes: ' num2str(NumberBoxes)] )
