...
debugMode = 0 ;
% System parameters
AixplorerIP = '192.168.4.119'; % IP address of Aixplorer
...
US_Duration = 10 * 1e3; % ms
NB_img_tir = 1 ; %round( HIFU_Duration_wanted / TA_per_img );
...
% try
    ...
    HIFU = elusev.hifu( ...
        ...
        'TxElemts', [ 9 10 9+64 10+64], ...10 + 64, ... sort(ok_chans_dab), ...
        'Phase', 0, ... 0*(0:127)/128*2*pi, ...phi_dab(sort(ok_chans_dab))*0, ...
        'DutyCycle', 1, ...
        'RxFreq', 1, ...
        'RxDuration', 0, ...
        'RxElemts', 0, ...
...
%         pause
        ...
        for n = 1:100
            n
            Sequence = Sequence.startSequence('Wait',0, 'auto_reload',1 );
            pause(9)
