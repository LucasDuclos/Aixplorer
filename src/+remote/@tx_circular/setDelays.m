...
switch system.probe.Type
    ...
    case 'linear' % linear probe
        ...
        warning('do to: add offset in phased array beamformer');
		removeOffset = false;
...
DelaysOffset = min(Delays(1:NbElemts));
if(removeOffset)
	Delays = Delays - DelaysOffset;
end
Delays(Delays < 1/system.hardware.ClockFreq) = 0;
...
obj = obj.setParam('tof2Focus', DelaysOffset);
